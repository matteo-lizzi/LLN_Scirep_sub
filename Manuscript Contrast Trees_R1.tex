...
Furthermore, CTs have the advantage of being easy to interpret and can be used as a diagnostic tool to detect the inaccuracies of every kind of model, for example, both those whose parameters estimate is based on a likelihood function and those based on machine learning algorithms. \color{black}
...
We set to 100 the maximum tree size corresponding to the number of regions. The choice of this parameter is not straightforward because it involves a trade-off between discrepancy and interpretability. The smaller the trees, the larger the regions (defined by simple rules and easy to be interpreted). The larger the trees, the higher the potential to uncover small high discrepancy regions (defined by complex rules).
...
{\includegraphics[width=0.33\textwidth]{lof_0}}
\subfloat[Base model - Age 30-60]
{\includegraphics[width=0.33\textwidth]{lof}}
\subfloat[Base model - Age 61-90]
{\includegraphics[width=0.33\textwidth]{lof_61}}\\
\subfloat[Boosted model - Age 0-29]
{\includegraphics[width=0.33\textwidth]{lof_0_b}}
\subfloat[Boosted model - Age 30-60]
{\includegraphics[width=0.33\textwidth]{lof_b}}
\subfloat[Boosted model - Age 61-90]
{\includegraphics[width=0.33\textwidth]{lof_61}}
\caption{Lack-of-fit contrast curves for APC (black), LC (blue), GBM (red), XGBM (orange) and XGBM prep (green).}
\label{fig:lof}
\end{figure}
%
...
\hline
\end{tabular}
\caption{Values of the average discrepancy $\bar{d}_m$ calculated on $m_{x,t}$.}
\label{tab:avecri}
\end{table}\\
...
\hline
\end{tabular}
\caption{Values of the RMSE and MAPE calculated on $m_{x,t}$.}
\label{tab:errors}
\end{table}
%
\color{blue}
...
\hline
\end{tabular}
\caption{Values of the average discrepancy $\bar{d}_m$ calculated on $\log{\left(m_{x,t}\right)}$.}
...
\end{tabular}
\caption{Values of the RMSE and MAPE calculated on $\log{\left(m_{x,t}\right)}$.}
...
For the sake of image readability, we colored in purple the regions presenting a discrepancy value exceeding XXX, 6e-04, and 0.008 for the age groups 0-29, 30-60, and 61-90, respectively.

\color{blue}For the age group 0-29, ADD COMMENTS \color{black} 
...
\caption{CTs regions, Base model. Regions presenting a discrepancy value exceeding XXX (age 0-29), 6e-04 (age 30-60), and 0.008 (61-90) are colored in purple.}
\label{fig:CT}
\end{figure}
%
\begin{figure}[H]
...
\caption{CTs regions, Boosted model. Regions presenting a discrepancy value exceeding XXX (age 0-29), 6e-04 (age 30-60), and 0.008 (61-90) are colored in purple.}
\label{fig:CT2}
\end{figure}
