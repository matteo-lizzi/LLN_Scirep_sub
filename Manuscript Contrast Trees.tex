...
%The literature relating to the mortality modeling and machine learning is growing. \color{blue} Citare le due scuole: ML come alternativa a canonical stochastic mortality models o come aggiuntivi \color{black} 
%to show how much better the machine learning model can do in terms of model fit and prediction accuracy
...
%It is worth emphasizing that basically none of the above models is able to generalize on a wide-global dataset over age and time. Indeed, some models work adequately in a subset of countries, or even more on a subset of specific age-ranges. 
...
%Specifically, \cite{LevNi} proposed to extrapolate the machine learning estimator on the whole mortality surface using the two-dimensional P-splines, obtaining more accurate mortality projection with respect to the Lee-Carter model. 
...
\centering
\subfloat[Base CTs]
{\includegraphics[width=0.51\textwidth]{lof_base}}
\subfloat[Boosted CTs]
{\includegraphics[width=0.51\textwidth]{lof_boosted}}
%:
...
\centering
\subfloat[Base CTs]
{\includegraphics[width=0.51\textwidth]{lof_61_base}}
\subfloat[Boosted CTs]
{\includegraphics[width=0.51\textwidth]{lof_61_boosted}}
...
%Therefore, in the worst case, where the average discrepancy is high, it is less likely that \hl{XXX} produces estimates for $m_{x,t}$ far from the observed values.
...
\end{table}
%
Results of the CTs, comparing the estimates of the models with the real mortality rates, provide the discrepancy measure for each region detected by the CTs. %\hl{(Appendix)}. 
...
\begin{figure}[H]
\centering
\subfloat[APC (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{apc.jpeg}}
{\includegraphics[width=0.25\textwidth]{apc_b.jpeg}}\\
\subfloat[LC(left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{lc.jpeg}}
{\includegraphics[width=0.25\textwidth]{lc_b.jpeg}}\\
\subfloat[GBM (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{gbm.jpeg}}
{\includegraphics[width=0.25\textwidth]{gbm_b.jpeg}}\\
\subfloat[XGBM (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{xgbm.jpeg}}
{\includegraphics[width=0.25\textwidth]{xgbm_b.jpeg}}\\
\subfloat[XGM prep (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{xgbm_preproc.jpeg}}
...
\centering
\subfloat[APC (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{apc_61.jpeg}}
{\includegraphics[width=0.25\textwidth]{apc_61_b.jpeg}}\\
\subfloat[LC (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{lc_61.jpeg}}
{\includegraphics[width=0.25\textwidth]{lc_61_b.jpeg}}\\
\subfloat[GBM (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{gbm_61.jpeg}}
...
\subfloat[XGM prep (left: base; right: boosted)]
{\includegraphics[width=0.25\textwidth]{xgbm_preproc_61.jpeg}}
...
\bibitem[Cairns et al.(2006)]{CBD08} 
